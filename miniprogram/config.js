...
module.exports = {
  ...
  app_version: "v1.14.2",
  // laf后台服务地址
  laf_url: 'https://ogequy.laf.run',
  // laf后台服务地址（微信开发工具中），一般和上面laf_url一致就好
  laf_dev_url: 'https://ogequy.laf.run',
  ...
  // 科普页图片
  science_imgs: [
    "https://oss.laf.run/ogequy-cat/科普1.png",
    "https://oss.laf.run/ogequy-cat/科普2.png",
    "https://oss.laf.run/ogequy-cat/科普3.png",
    "https://oss.laf.run/ogequy-cat/科普4.png",
    "https://oss.laf.run/ogequy-cat/科普5.png"
  ],

  // 赞赏码图片
  reward_img: "https://oss.laf.run/ogequy-cat/赞赏码.jpg",
  // 新猫问卷图片
  feedback_wj_img: "https://oss.laf.run/ogequy-cat/新猫问卷.png",
  // 小程序菊花码图片
  mpcode_img: "https://oss.laf.run/ogequy-cat/菊花码.jpg",

  // 徽章排行榜的数量榜logo
  badge_rank_count_img: "https://oss.laf.run/ogequy-cat/badge_rank_count.png",
  // 徽章排行榜的价值榜logo
  badge_rank_score_img: "https://oss.laf.run/ogequy-cat/badge_rank_score.png",
